...
export default function WhatsAppInvite() {
  ...
  return (
    <section style={styles.section}>
      ...
      {/* ── Action Buttons only — no preview card ── */}
      <div style={styles.buttonRow}>
        ...
        >
          {copied ? (
            <><CheckIcon size={18} color="#4CAF50" /><span style={{ color: "#4CAF50" }}>Copied!</span></>
          ) : (
            <><CopyIcon size={18} color="#C8955A" /><span>Copy Text</span></>
          )}
        </button>
      </div>

      <p style={styles.footerNote}>
        WhatsApp will open with the invitation pre-filled — just choose your contacts and send 💕
      </p>
    </section>
  );
}
